...
from urdf2mjcf_utils import iter_meshes, save_xml
...
def main() -> None:
     ...
     parser.add_argument("urdf_path", type=str, nargs='?', default="/home/geonhyup/Desktop/Research/open-sim-mujoco/models/assets/partnet/41083/mobility.urdf",
     ...
     parser.add_argument("--output", type=str, help="The path to the output MJCF file.", default="/home/geonhyup/Desktop/Research/open-sim-mujoco/models/assets/partnet/41083/mobility.xml")
     ...
     # Mesh directory path 설정
     mesh_directory = "/home/geonhyup/Desktop/Research/open-sim-mujoco/models/assets/partnet/41083/textured_objs"
