...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--obj_dir', 
        type=str, 
        default='data_1128_new_all/0172@f877d2a1-678f-49a0-a90e-e99ff27134c7_DiningRoom-13034_cfg1.0_1.0/tmp')
    ...
    refined_obj_bbox_list, _ = resolve_collision(obj_bbox_list, margin=0.01, check_z=False)
