...
os.system("mkdir -p out/diningroom_sg2scdiffusion_objfeat/checkpoints")
...
os.system(f"wget {url} -O out/diningroom_sg2scdiffusion_objfeat/checkpoints/epoch_01999.pth")
os.system("mkdir -p out/diningroom_sgdiffusion_vq_objfeat/checkpoints")
...
os.system(f"wget {url} -O out/diningroom_sgdiffusion_vq_objfeat/checkpoints/epoch_01239.pth")