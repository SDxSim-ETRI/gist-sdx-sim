...
def main():
    ...
    ROOM_TPYE = "bedroom"
    # ROOM_TPYE = "diningroom"
    # ROOM_TPYE = "livingroom"
    parser.add_argument(
        "--config_file", type=str,
        # default=f"configs/{ROOM_TPYE}_sg2sc_diffusion_objfeat.yaml",
        # default=f"configs/{ROOM_TPYE}_sg_diffusion_vq_objfeat.yaml",
        default=f"configs/{ROOM_TPYE}_sg_diffusion_vq_objfeat_mod.yaml",
        help="Path to the file that contains the experiment configuration"
    )
    parser.add_argument(
        "--tag", type=str,
        # required=True,
        default="bedroom_sgdiffusion_vq_objfeat",
        help="Tag that refers to the current experiment"
    )
    parser.add_argument(
        "--fvqvae_tag", type=str,
        # required=True,
        default="threedfront_objfeat_vqvae",
        help="Tag that refers to the fVQ-VAE experiment"
    )
    parser.add_argument(
        "--fvqvae_epoch", type=int,
        default=1999,
    ...
    parser.add_argument(
        "--sg2sc_tag", type=str,
        # required=True,
        default="bedroom_sg2scdiffusion_objfeat",
        help="Tag that refers to the Sg2Sc experiment"
    )
    parser.add_argument(
        "--sg2sc_epoch", type=int,
        default=1999,
